    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="http://localhost/DO_AN_PHP_MYSQL_2023/admin/uploads/xulyadd_nhasanxuat.php" method="POST">
                    <div class="mb-3">
...
<div class="modal fade" id="editModal<?php echo $row['MaNhaSanXuat']; ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="http://localhost/DO_AN_PHP_MYSQL_2023/admin/uploads/xulyedit_nhasanxuat.php" method="POST">
